...
// state of the webapp
let currentPage = 0, img, companyInfo, stepper, splashScreen, homePage, pageInfo, pager;
...
function onPageMount() {
    ...
    for(let i = 1; i <= _data.totalPages; i++){
        ...
        if (_data.pageData[i - 1][1] === "right") div.classList.add("right");
        div.innerHTML = _data.pageData[i - 1][0];
        fragment.appendChild(div);
    }
    pageInfo.appendChild(fragment);
    for(let i1 = 0; i1 <= _data.totalPages + 1; i1++){
        const div = document.createElement("div");
        const innerDiv = document.createElement("div");
        if (i1 === 0) innerDiv.classList.add("selected");
        innerDiv.dataset.type = "page";
        innerDiv.id = "page" + i1;
        innerDiv.textContent = i1 < 1 || i1 > _data.totalPages ? "" : String(i1);
...
function setPageNumberToHolder(pageNo) {
    document.getElementById("bgImgHolder").dataset.page = String(pageNo);
}
function updateStepper(pageNo) {
    if (pageNo === 0) {
        ...
        stepper.textContent = `Step ${pageNo} out of 8 on the path of enlightenment`;
        companyInfo.style.transform = `translateX(${2 * window.innerWidth / 3}px)`;
        img.style.transform = `translateX(${_data.offsetPercent[pageNo]})`;
        stepper.style.display = "block";
        return true;
    } else return false;
}
...
function displayPageMark(pageNo) {
    document.querySelector(".selected")?.classList.remove("selected");
    document.getElementById("page" + pageNo).classList.add("selected");
}

},{"./utils/data":"cYJ9f"}],"cYJ9f":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "totalPages", ()=>totalPages
);
parcelHelpers.export(exports, "offsetPercent", ()=>offsetPercent
);
parcelHelpers.export(exports, "pageData", ()=>pageData
);
const totalPages = 8;
const offsetPercent = [
    "0px",
...
const pageData = [
    ...
    [
        `Individuals flourish<br />if culture<br />and wisdom<br />are shared`,
        "left"
    ],
    [
...
},{}]},["8wcER","h7u1C"], "h7u1C", "parcelRequire11de")
